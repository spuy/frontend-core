...
#### Menú
Aperurar un proceso dede el menú:
1. Desplegar el arbol de menu en **Relacion con Socios del Negocio**.
2. Seleccionar el proceso **Envio Texto Correo Electronico**.
